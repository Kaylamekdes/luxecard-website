...
export function Testimonials() {
  return (
    <RevealSection
      id="testimonials"
      className="scroll-mt-[84px] overflow-hidden border-t border-[rgba(255,255,255,.06)] py-[clamp(56px,8vh,100px)] min-[900px]:scroll-mt-[96px] md:py-[clamp(90px,13vh,150px)]"
    >
