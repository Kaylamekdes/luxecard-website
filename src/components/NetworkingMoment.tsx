...
export function NetworkingMoment() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="absolute left-[clamp(20px,4vw,48px)] top-6 font-inter text-[9.5px] tracking-[.14em] text-grey-1"
      >
        FULL-BLEED FILM STILL — NETWORKING EVENING, HANDSHAKE INTO TAP
      </div>
